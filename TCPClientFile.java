...
public class TCPClientFile extends Thread
{
	...
	public TCPClientFile(String fileName, int port)
	{
	...
	public static void main(String[] args) throws Exception
	{
		...
		TCPClientFile[] myChatClient = new TCPClientFile[5];
		...
		{
			myChatClient[i] = new TCPClientFile(fileNames[i], port);
			port++;
			myChatClient[i].start();
		}
		for (int i = 0; i < 5; i++)
